...
ActiveRecord::Schema.define(version: 20_210_512_214_952) do
  ...
  create_table 'product_attributes_values_variations', id: false, force: :cascade do |t|
    ...
    t.index %w[product_attributes_value_id product_variation_id], name: 'attrs_value_to_product_variation'
    t.index %w[product_variation_id product_attributes_value_id], name: 'variation_to_attrs_value'
  end
  ...
  create_table 'product_carts', force: :cascade do |t|
    ...
    t.bigint 'product_id'
    t.index %w[product_type product_id], name: 'index_product_carts_on_product_type_and_product_id'
  end
  ...
  create_table 'product_meta', force: :cascade do |t|
    ...
    t.string 'product_type'
    t.bigint 'product_id'
    t.index %w[product_type product_id], name: 'index_product_meta_on_product_type_and_product_id'
  end
